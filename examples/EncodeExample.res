...
// prints ["foo", "bar"]
let _ = ["foo", "bar"]->Json.Encode.stringArray->Console.log

// Encode string array, slower but more flexible
// prints ["foo", "bar"]
let _ = ["foo", "bar"]->Json.Encode.array(Json.Encode.string)(_)->Console.log
...
// prints { x: 42, foo: 'bar' }
let _ =
  Json.Encode.object([("x", Json.Encode.int(42)), ("foo", Json.Encode.string("bar"))])->Console.log
...
let _ = Encode.line(~points=[{x: 1.1, y: -0.4}, {x: 5.3, y: 3.8}], ~thickness=2, ())->Console.log
